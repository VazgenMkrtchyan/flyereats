        ...
        <div class="container">
            ...
            <div class="nav-menu">
                <ul class="menu">
                    ...
                    <li data-li-identifier="pages.about-us"><a href="https://carsaleweb.co.uk/brighton/sell-your-car"><?php echo trans('Sell Your Car'); ?></a></li>
                    <li data-li-identifier="pages.about-us"><a href="https://carsaleweb.co.uk/brighton/part-exchange"><?php echo trans('Part Exchange'); ?></a></li>
