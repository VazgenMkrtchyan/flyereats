    ...
    <div class="row">
        ...
        <!--<div class="col-xs-12">
            ...
            <div>
                ...
                <?php else: ?>
                    <a href="<?php echo route('compprofile.edit'); ?>">
                        <button class="btn-main btn-fixed" type="button">
                            <i class="fa fa-pencil"></i> <?php echo trans('front.edit_compprofile'); ?>

                        </button>
                    </a>
                    <a href="<?php echo route('compprofile.destroy');; ?>" data-delete="<?php echo csrf_token();; ?>" data-confirm="Do you really want to delete your company profile?">
                        <button class="btn-main btn-fixed btn-red" type="button">
                            <i class="fa fa-trash-o"></i> <?php echo trans('front.delete_compprofile'); ?>
