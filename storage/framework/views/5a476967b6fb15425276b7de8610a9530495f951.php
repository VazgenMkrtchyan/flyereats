...
<?php $__env->startSection('page-content'); ?>
    ...
    <div class="page-content-area">
        <div class="row">
            <div class="col-xs-12">
                ...
                <?php echo Form::model($feature, ['route' => ['admin.data_features.update', $feature->id], 'class' => 'form-horizontal', 'id' => 'form-val', 'method' => 'PATCH']); ?>
                ...
                <div class="clearfix form-actions">
                    <div class="col-sm-offset-3 col-sm-9">
                        ...
                        <!-- cancel button -->
                        <a href="<?php echo route('admin.data_features.index'); ?>" class="btn btn-danger">
    ...
    <?php echo Form::hidden('nav_li_identifier', 'admin.data_features.index'); ?>

<?php $__env->stopSection(); ?>


<?php $__env->startSection('additional-scripts'); ?>
    <?php echo $__env->make('admin.data-fields.features.js.js-create-edit', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
