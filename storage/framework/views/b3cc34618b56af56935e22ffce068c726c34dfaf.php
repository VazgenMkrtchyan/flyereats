    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-3">
                ...
                <div class="info">
                  <p> Welcome to Newcastle</p>
                  <p><i class="fa fa-map-marker"></i>160 Kemp House, City Road,</br> London, England, EC1V 2NX</p>
            ...
            <div class="col-sm-3">
                ...
                <div class="social-link"><i class="fa fa-google-plus-square"></i><a href="#" target="_blank">Find us on Google</a></div>
                <div class="social-link"><i class="fa fa-linkedin"></i><a href="#" target="_blank">Follow us on Linkedin</a></div>
