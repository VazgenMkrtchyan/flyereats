<div id="sidebar" class="sidebar navbar-collapse collapse">
    ...
    <ul class="nav nav-list">
        ...
        <?php if(Auth::user()->IsSuper()): ?>
            <li class="" data-li-top="site-configuration">
                ...
                <ul class="submenu">
                    ...
                    <li class="" data-li-identifier="admin.settings.payment">
                    ...
                    <li class="" data-li-identifier="admin.settings.email-not">
                    ...
                    <?php if(Auth::user()->hasPermission('admin.listings.index')): ?>
                        <li class="" data-li-identifier="admin.listings.index">
                            <a href="<?php echo route('admin.listings.index'); ?>">
                                <i class="menu-icon fa fa-caret-right"></i>
                                <?php echo trans('back.manage_listings'); ?>
            ...
            <li class="" data-li-top="users">
                ...
                <ul class="submenu">
                    ...
                    <?php if(Auth::user()->hasPermission('admin.users.index')): ?>
                        <li class="" data-li-identifier="admin.users.index">
                    ...
                    <?php if(Auth::user()->hasPermission('admin.user-groups.index')): ?>
                        <li class="" data-li-identifier="admin.user-groups.index">
                    ...
                    <?php if(Auth::user()->hasPermission('admin.users.create')): ?>
                        <li class="" data-li-identifier="admin.users.create">
        ...
        <?php if(Auth::user()->hasPermissionsInGroup('company-profiles')): ?>
            <li class="" data-li-top="company-profiles">
                <a href="#" class="dropdown-toggle">
        ...
        <?php if(Auth::user()->IsSuper()): ?>
            <li class="" data-li-top="data-fields">
                <a href="#" class="dropdown-toggle">
                    ...
                    <span class="menu-text"> <?php echo trans('back.data_fields'); ?> </span>
                    <b class="arrow fa fa-angle-down"></b>
                </a>
                <b class="arrow"></b>
                ...
                <ul class="submenu">
                    ...
                    <li class="" data-li-identifier="admin.data_solo.states">
        ...
        <?php if(Auth::user()->IsSuper()): ?>
            <li class="" data-li-top="pricing-options">
                <a href="#" class="dropdown-toggle">
                ...
                <ul class="submenu">
                    ...
                    <li class="" data-li-identifier="admin.membership-plans.index">
        ...
        <?php if(Auth::user()->hasPermissionsInGroup('payments')): ?>
            <li class="" data-li-identifier="admin.payments.index">
        ...
        <?php if(Auth::user()->IsSuper()): ?>
            <li class="" data-li-identifier="admin.permissions">
