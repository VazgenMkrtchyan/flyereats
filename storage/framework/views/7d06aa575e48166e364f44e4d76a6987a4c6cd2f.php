...
<!-- Seller Details -->
                        ...
                        <div class="side-widget" id="listing-enquiry">
                            <div class="header"><i class="fa fa-envelope-o" style="color:red;"></i> <?php echo trans('front.enquire_listing'); ?></div>
                            <div class="content">
                        ...
                        <div class="side-widget social-share-links">
                            <div class="header"><i class="fa fa-share-alt" style="color:red;"></i> <?php echo trans('front.social_share_links'); ?></div>
                            <div class="content">
