                                        ...
                                        <div class="col-sm-2">
                                            <div class="l-photo">
                                                ...
                                                <?php if($listing->isFeatured()): ?>
                                                    <span class="label label-danger"><?php echo trans('back.featured'); ?></span>
                                                <?php endif; ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <?php if(appCon()->listingPlansBased()): ?>
                                                        <?php echo trans('back.listing_plan'); ?>: <?php echo $listing->listing_plan_id ? $listing->listingPlan->name : trans('front.NONE'); ?> <br>
                                                        <?php echo trans('back.listing_exp_date'); ?>: <?php echo $listing->expires_on ? format_date($listing->expires_on) : trans('front.NEVER'); ?> <br>
                                                    <?php else: ?>
                                                        <?php echo trans('back.listing_exp_date'); ?>: <?php echo trans('back.when_membership_expires'); ?><br>
                                                    <?php endif; ?>
