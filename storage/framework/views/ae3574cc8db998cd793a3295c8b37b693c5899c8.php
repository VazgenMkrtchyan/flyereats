<a href="<?php echo $listing->present()->seoUrl; ?>" class="listing">
    ...
    <div class="listing-data <?php echo $listgrid; ?>">
        ...
        <table class="info-table">
            <tr>
                <td class="option">Condition:</td>
                <td class="spec"><?php echo $listing->present()->carCondition; ?></td>
            </tr>
            <tr>
        ...
        <div class="visible-lg">
            <table class="info-table secondary">
                <tr>
                    <td class="option">Body Style:</td>
                    <td class="spec"><?php echo $listing->present()->carBodyStyle; ?></td>
                </tr>
                <tr>
