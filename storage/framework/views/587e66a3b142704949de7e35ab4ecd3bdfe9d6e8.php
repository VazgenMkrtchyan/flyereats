    ...
    <ul class="nav nav-list">
        ...
        <li class="" data-li-top="dashboard">
            ...
            <ul class="submenu">
                ...
                <li class="" data-li-identifier="admin.profile.edit" style="display:none;">
            ...
            <li class="" data-li-top="listings">
                ...
                <ul class="submenu">
                    ...
                    <?php if(Auth::user()->hasPermission('admin.listings.index')): ?>
                        <li class="" data-li-identifier="admin.listings.index" style="display:none;">
        ...
        <?php if(Auth::user()->IsSuper()): ?>
            <li class="" data-li-top="administrators" style="display:none;">
                <a href="#" class="dropdown-toggle">
