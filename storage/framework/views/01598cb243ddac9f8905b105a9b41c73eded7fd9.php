    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-3">
                ...
                <div class="info">
                  <p> Welcome to Ipswich Autos</p>
                  <p><i class="fa fa-map-marker"></i>31 lower Orwell street</br>
Ipswich IP41BU</p>
                    <p><i class="fa fa-phone"></i>01473 760 696</p>
                                        <p><i class="fa fa-envelope-o"></i>sales@ipswichautos.co.uk</p>
