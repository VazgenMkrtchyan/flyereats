<div class="header-master">
    ...
    <div class="nav-wrapper">
        <div class="container">
            ...
            <?php if(appCon()->logo): ?>
                <div class="nav-logo">
                    <a href="http://stock.indigorental.com/"><img src="<?php echo asset( 'uploads/logos/' . (demo_mode_on() ? ('auto_' . sessionOrWebc('color_scheme', 'color_scheme') . '.png') : appCon()->logo) ); ?>"></a>
                </div>
            <?php endif; ?>
            ...
            <div class="nav-menu">
                <ul class="menu">
                    ...
                    <li ><a href="http://stock.indigorental.com/"><?php echo trans('front.home'); ?></a></li>
                    <li data-li-identifier="browselistings.index"><a href="<?php echo route('browselistings.index'); ?>">Vehicles</a></li>


                    <li data-li-identifier="pages.about-us"><a href="<?php echo route('pages.about-us'); ?>"><?php echo trans('front.about_us'); ?></a></li>
                    <li data-li-identifier="pages.faq"><a href="https://www.indigorental.com/faqs"><?php echo trans('front.FAQ'); ?></a></li>
                    <li data-li-identifier="contactus.index"><a href="https://www.indigorental.com/contact-us"><?php echo trans('front.contact_us'); ?></a></li>
                    <li data-li-identifier="contactus.index"><a href="https://www.indigorental.com">Return to Main Site</a></li>
