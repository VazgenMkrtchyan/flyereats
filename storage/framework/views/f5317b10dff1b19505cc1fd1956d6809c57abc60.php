        ...
        <div class="container">
            ...
            <div class="nav-menu">
                <ul class="menu">
                    ...
                    <?php if(Auth::guest()): ?>
                        <li class="has-sub">
                            <a href="#"><?php echo trans('front.login_register'); ?></a>
                            <ul class="sub-menu">
                                <li data-li-identifier="sessions.create"><a href="<?php echo route('sessions.create'); ?>"><?php echo trans('front.login'); ?></a></li>
                                <li data-li-identifier="register"><a href="<?php echo route('register'); ?>"><?php echo trans('front.register'); ?></a></li>
                            </ul>
                        </li>
                    <?php endif; ?>

                    <li class="has-sub"><a href="#"><?php echo trans('front.about_FAQ'); ?></a>
                        <ul class="sub-menu">
                            <li data-li-identifier="pages.about-us"><a href="<?php echo route('pages.about-us'); ?>"><i class="fa fa-info-circle"></i> <?php echo trans('front.about_us'); ?></a></li>
                            <li data-li-identifier="contactus.index"><a href="<?php echo route('contactus.index'); ?>"><i class="fa fa-envelope-o"></i> <?php echo trans('front.contact_us'); ?></a></li>
                            <li data-li-identifier="pages.faq"><a href="<?php echo route('pages.faq'); ?>"><i class="fa fa-question-circle"></i> <?php echo trans('front.FAQ'); ?></a></li>
                            </li>
                        </ul>
                    </li>
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="sub-menu">
                                <?php if(Auth::user()->isSimple()): ?>
                                    ...
                                    <li data-li-identifier="userpayments.index"><a href="<?php echo route('userpayments.index'); ?>"><i class="fa fa-money"></i> <?php echo trans('front.view_payments'); ?></a></li>
                                <?php else: ?>
