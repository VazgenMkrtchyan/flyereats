    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-3">
                ...
                <div class="info">
                  <p> Welcome to Indigo</p>
                  <p><i class="fa fa-map-marker"></i>Southwell Road West Rainworth Mansfield Nottinghamshire</br> England NG21 0HW</p>
                    <p><i class="fa fa-phone"></i>01623 888 393</p>
                    <p><i class="fa fa-envelope-o"></i>david.heasley@indigofleet.co.uk</p>
                                        <p><i class="fa fa-envelope-o"></i>carwyn.lewis@indigofleet.co.uk</p>
    ...
    <div class="sub-footer">
        <div class="container">
            <div class="copyright">
                ...
                Copyright © 2020 | <a href="#" target="_blank"></a> All Rights Reserved.
