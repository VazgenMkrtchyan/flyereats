<?php $__env->startSection('meta-title', siteTitle(trans('front.title_edit_profile'))); ?>

<?php $__env->startSection('content'); ?>

        <!--email changed notify-->
<div class="alert alert-success" role="alert" id="alert-email-changed" style="display: none">
    <?php echo trans('front.email_changed'); ?>
...
<div class="alert alert-warning" role="alert" id="alert-email-change-confirm" style="display: none">
    <?php echo trans('front.email_change_after'); ?>

</div>

<h1><i class="fa fa-user"></i> <?php echo trans('front.your_profile'); ?></h1>

<!-- Form -->
<?php echo Form::model($user, ['route' => 'profile.update', 'class' => 'form-horizontal', 'method' => 'PATCH', 'id' => 'form-val']); ?>


        <!-- select box for 'user_group_id'-->
<div class="form-group">
    <?php echo Form::label('type', trans('front.user_group').': *', ['class'=>'col-sm-3 col-md-2 control-label']); ?>

    <div class="col-sm-6 col-md-4">
        <?php echo Form::select('user_group_id', $details['UserGroups'], null, ['class'=>'form-control', 'disabled']);; ?>
...
<div class="form-group">
    ...
    <div class="col-sm-6 col-md-4">
        <?php echo Form::text('username', null, ['class' => 'form-control', 'disabled']); ?>
...
<!-- password -->
<div class="form-group">
    <?php echo Form::label('password', trans('front.new_password').':', ['class'=>'col-sm-3 col-md-2 control-label']); ?>
...
<div class="form-group">
    ...
    <div class="col-sm-6 col-md-4">
        ...
        <div><a href="#" data-toggle="modal" data-target="#modal-change-email"><?php echo trans('front.change_email'); ?></a></div>
    </div>
</div>
...
<div class="form-group margin-t-30">
    <div class="col-sm-offset-3 col-md-offset-2 col-sm-6 col-md-4">
        <button class="btn-main" type="submit">
            <?php echo trans('front.UPDATE_PROFILE'); ?>
...
<?php $__env->startSection('modals'); ?>
        <!--modals-->
<?php echo $__env->make('front.user-profile.partials.modal-change-email', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('additional-scripts'); ?>
    <?php echo $__env->make('front.user-profile.js.js-edit', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
