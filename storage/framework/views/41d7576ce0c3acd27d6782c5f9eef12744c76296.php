        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <?php if(Auth::user()->hasPermission('admin.listings.index')): ?>
                    <a href="<?php echo route('admin.listings.create', ['moderationStatus' => 'pending']); ?>" class="btn btn-app btn-warning no-radius">
                        <i class="ace-icon fa fa-car bigger-230"></i>
                        <?php echo trans('Add Car </br> Listing'); ?> 
                    </a>
                <?php endif; ?>
                 <a href="<?php echo route('admin.listings.index'); ?>" class="btn btn-app btn-blue no-radius">
                    <i class="ace-icon fa fa-list bigger-230"></i>
                    <?php echo trans('Manage </br> Stocklist'); ?>
                ...
                <a href="<?php echo route('admin.data_makes.index'); ?>" class="btn btn-app btn-warning no-radius">
                    <i class="ace-icon fa fa-tasks bigger-230"></i>
                    <?php echo trans('Manage</br>Make/Model'); ?>

                </a>
                <a href="<?php echo route('admin.settings.site-pref'); ?>" class="btn btn-app btn-success no-radius">
                    <i class="ace-icon fa fa-cogs bigger-230"></i>
                    <?php echo trans('Website</br>Settings'); ?>
