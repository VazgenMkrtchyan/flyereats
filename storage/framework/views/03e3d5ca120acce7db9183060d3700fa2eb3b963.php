...
<?php $__env->startSection('meta-title', trans('back.browse_and_manage_listing_plans')); ?>
...
<?php $__env->startSection('page-content'); ?>
    ...
    <div class="page-header">
        <h1>
            ...
            <small>
                ...
                <?php echo trans('back.browse_and_manage_listing_plans'); ?>

            </small>

            <a href="<?php echo route('admin.listing-plans.create'); ?>" class="pull-right">
                <button class="btn btn-white btn-pink btn-bold">
                    <span class="ace-icon fa fa-plus icon-on-left"></span>
                    <?php echo trans('back.add_listing_plan'); ?>
    ...
    <?php echo $__env->make('admin.listing-plans.partials.note', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-collapse collapse" id="userGroup<?php echo $userGroup->id; ?>" aria-expanded="false" style="height: 0px;">
                                <div class="panel-body">
                                    <!-- MEMBERSHIP PLANS -->
                                    <?php echo $__env->make('admin.listing-plans.partials.listing-plans', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                </div>
                            </div>
                        </div>
