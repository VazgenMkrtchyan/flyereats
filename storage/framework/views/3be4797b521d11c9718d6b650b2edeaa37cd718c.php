<div class="side-widget company-profile">
    ...
    <div class="content">
        ...
        <?php endif; ?>
        <div class="comp-name">Indigo </div>
        ...
        <?php endif; ?>
        <div class="comp-info"><i class="fa fa-map-marker"></i>Southwell Road West Rainworth Mansfield</br>Nottinghamshire
England NG21 0HW</div>
