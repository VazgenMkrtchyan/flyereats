    ...
    <div class="page-content-area">
        <div class="row">
            <div class="col-xs-12">
                ...
                <?php echo Form::open(['route' => ['admin.data_solo.store', 'dataField' => $dataField], 'class' => 'form-horizontal', 'id' => 'form-val', 'method' => 'POST']); ?>
                ...
                <div class="clearfix form-actions">
                    <div class="col-sm-offset-3 col-sm-9">
                        ...
                        <!-- cancel button -->
                        <a href="<?php echo route('admin.data_solo.index', $dataField); ?>" class="btn btn-danger">
...
<?php $__env->startSection('additional-scripts'); ?>
    <?php echo $__env->make('admin.data-fields.identic.js.js-create-edit', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
