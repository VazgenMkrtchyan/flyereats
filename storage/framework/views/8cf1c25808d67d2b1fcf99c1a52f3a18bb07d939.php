...
<?php endif; ?>
<script src='https://www.google.com/recaptcha/api.js?render=onload<?php echo (isset($lang) ? '&hl='.$lang : ''); ?>'></script>
<div class="g-recaptcha" data-sitekey="<?php echo $public_key; ?>" <?=renderDataAttributes($dataParams)?>></div>
<noscript>
