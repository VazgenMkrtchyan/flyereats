...
@section('meta-title', trans('back.browse_and_manage_listing_plans'))
    ...
    <div class="page-header">
        <h1>
            ...
            <small>
                ...
                {{ trans('back.browse_and_manage_listing_plans') }}
            </small>

            <a href="{{ route('admin.listing-plans.create') }}" class="pull-right">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-collapse collapse" id="userGroup{{ $userGroup->id }}" aria-expanded="false" style="height: 0px;">
                                <div class="panel-body">
                                    <!-- MEMBERSHIP PLANS -->
                                    @include('admin.listing-plans.partials.listing-plans')
                                </div>
                            </div>
                        </div>
