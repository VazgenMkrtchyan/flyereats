...
<!-- text field for 'Name'-->
<div class="form-group">
    {{ Form::label('name', trans('back.plan_name').': *', ['class'=>'col-sm-3 control-label no-padding-right']) }}
    <div class="col-xs-10 col-sm-5">
...
<div class="form-group">
    {{ Form::label('max_listings', trans('back.max_listings_with').': *', ['class'=>'col-sm-3 control-label no-padding-right']) }}
    <div class="col-xs-10 col-sm-5">
    ...
    <div class="col-sm-offset-3 col-sm-9">
        <div class="checkbox">
            <label>
                ...
                <span class="lbl"> {{ trans('back.automatically_confirm_listing_after_payment') }}</span>
            </label>
        </div>
    </div>
</div>
...
@section('additional-scripts')
    @include('admin.listing-plans.js.js-create-edit')
@stop
