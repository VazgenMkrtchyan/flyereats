...
<div class="listing-photos">
    <div class="row">
        @for ($i = 0; $i < count($photos); $i++)
            <div class="col-sm-6 col-md-4 col-lg-3 center img-listing-photo" data-photo-block="{{ $photos[$i]->id }}">
                <div>
                ...
                <div class="photo-actions margin-t-10 margin-b-10">
                    ...
                    <button type="button" class="btn btn-white btn-primary btn-bold" data-rotate-photo="{{ $photos[$i]->id }}" data-rotate="0">
