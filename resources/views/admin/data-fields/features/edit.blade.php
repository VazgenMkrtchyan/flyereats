...
@section('page-content')
    ...
    <div class="page-content-area">
        <div class="row">
            <div class="col-xs-12">
                ...
                {{ Form::model($feature, ['route' => ['admin.data_features.update', $feature->id], 'class' => 'form-horizontal', 'id' => 'form-val', 'method' => 'PATCH']) }}
                ...
                <div class="clearfix form-actions">
                    <div class="col-sm-offset-3 col-sm-9">
                        ...
                        <!-- cancel button -->
                        <a href="{{ route('admin.data_features.index') }}" class="btn btn-danger">
    ...
    {{ Form::hidden('nav_li_identifier', 'admin.data_features.index') }}
@stop


@section('additional-scripts')
    @include('admin.data-fields.features.js.js-create-edit')
@stop