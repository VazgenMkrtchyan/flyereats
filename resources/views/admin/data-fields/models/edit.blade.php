...
@section('page-content')
    ...
    <div class="page-header">
        <h1>
            {{ trans('back.data_fields_for', ['for' => $parent->name]) }}
            <small>
                <i class="ace-icon fa fa-angle-double-right"></i>
                {{ trans('back.edit_model') }}
            </small>
    ...
    <div class="page-content-area">
        <div class="row">
            <div class="col-xs-12">
                ...
                {{ Form::model($model, ['route' => ['admin.data_models.update', $parent->id, $model->id], 'class' => 'form-horizontal', 'id' => 'form-val', 'method' => 'PATCH']) }}
                ...
                <div class="clearfix form-actions">
                    <div class="col-sm-offset-3 col-sm-9">
                        ...
                        <!-- cancel button -->
                        <a href="{{ route('admin.data_models.index', $parent->id) }}" class="btn btn-danger">
...
@section('additional-scripts')
    @include('admin.data-fields.models.js.js-create-edit')
@stop