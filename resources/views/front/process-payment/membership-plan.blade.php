...
@section('content')
    ...
    <form action="@if (appCon()->pp_sandbox) https://www.sandbox.paypal.com/cgi-bin/webscr @else https://www.paypal.com/cgi-bin/webscr @endif" method="post" id="proceed">
        ...
        <input type="hidden" name="item_name" value="{{ $membershipPlan->name }} (Membership Plan #{{ $membershipPlan->id }})">
        <input type="hidden" name="amount" value="{{ $membershipPlan->price }}">
...
@section('additional-scripts')
    @include('front.process-payment.js.js-membership-plan')
@stop