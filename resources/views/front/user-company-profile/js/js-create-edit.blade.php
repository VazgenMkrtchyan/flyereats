<script>
    $( document ).ready( function() {
        ...
        formVal.validate({
            ...
            messages: {
                name: {
                    required: "{{ trans('front.company_name') . trans('front.required_not_empty') }}"
                },
                state_id: {
        ...
        $( '#company-logo' ).validate({
            ...
            messages: {
                logo: {
                    required: "{{ trans('front.select_file_to_upload') }}",
                    accept: "{{ trans('front.not_valid_image') }}"
                }
            }
        });
